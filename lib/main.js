(function() {
  'use strict';
  var CND, E, SQL, badge, debug, echo, freeze, help, info, isa, lets, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
...
create table if not exists ${x}tagged_ids_cache (
  ...
  order by nr;`
      ...
      _create_sql_functions() {
        var foo, x;
        x = this.cfg.prefix;
        foo = this.dba.prepare("select 42;");
        //.......................................................................................................
        this.dba.create_function({
          ...
          call: (id) => {
            ...
            debug('^444552^', this.dba.sqlt.unsafeMode(true));
            debug('^444552^', [...(foo.iterate())]);
